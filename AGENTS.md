...
- Follow the prioritized shared instructions in [escemi-tech/.github/AGENTS.md](https://github.com/escemi-tech/.github/blob/main/AGENTS.md) before working in this repository.

## Quick Start

This repository hosts ESCEMI's marketing site, built with Astro 5 and Tailwind CSS inside the `application/` directory. Environment requirements, setup commands, and the development workflow live in the [Project readme](README.md).
